...
{\Large \mfMobileDevice, {VSCode, Visual Studio, Android Studio, IntelliJ, Unity3D }}, 
...
\programmings{14/materialpink/\mfUnity \textbf{ C\#}
, 18/orange/ \ \mfPython \textbf{ Python}
, 19/green/ \ \mfJavaBold \textbf{Java / Kotlin}
, 19/materialcyan/\mfReactjs \textbf{ React.js}
% , 7/materialteal/\textbf{R}
, 6/materialamber/\mfHtml \textbf{ Html}
, 9/materialblue/\mfCss \textbf{ Css}
, 15/materialred/\textbf{ C++}
% , 3/materiallime/\mfPhp \textbf{ PHP}
}{2.25}{0.75}

% Interest icons text
\interests{ \textbf{\textcolor{materialindigo}{Gymming, Sailing, Windsurfing, Contract Bridge, Poker, Investment}} }
